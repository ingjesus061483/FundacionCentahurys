...
<head>
    ...
    <title><?=trim($empresa->valor)?> - <?=$name?> </title>
    <link rel="shortcut icon" type="image/x-icon" href="<?=$url?>sb-admin/img/fundacioncentahury.ico" />             
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$usuario->user?></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="<?=$url?>/administracion/user/changepassword.php?user=<?=trim($usuario->user)?>">
